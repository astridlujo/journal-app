...
// node_modules/@tamagui/config/node_modules/@tamagui/shorthands/dist/esm/v4.mjs
var shorthands = {
  // text
  text: "textAlign",
  // view
...
// node_modules/@tamagui/themes/node_modules/@tamagui/create-theme/dist/esm/isMinusZero.mjs
function isMinusZero(value) {
  return 1 / value === Number.NEGATIVE_INFINITY;
}
__name(isMinusZero, "isMinusZero");

// node_modules/@tamagui/themes/node_modules/@tamagui/create-theme/dist/esm/themeInfo.mjs
...
// node_modules/@tamagui/themes/node_modules/@tamagui/create-theme/dist/esm/createTheme.mjs
...
// node_modules/@tamagui/themes/node_modules/@tamagui/create-theme/dist/esm/helpers.mjs
...
// node_modules/@tamagui/themes/node_modules/@tamagui/create-theme/dist/esm/masks.mjs
...
// node_modules/@tamagui/themes/node_modules/@tamagui/create-theme/dist/esm/applyMask.mjs
...
// node_modules/@tamagui/themes/node_modules/@tamagui/create-theme/dist/esm/combineMasks.mjs
var combineMasks = /* @__PURE__ */ __name((...masks3) => ({
  name: "combine-mask",
  mask: /* @__PURE__ */ __name((template, opts) => {
    let current = getThemeInfo(template, opts.parentName), theme;
    for (const mask2 of masks3) {
...
// node_modules/@tamagui/themes/node_modules/@tamagui/theme-builder/dist/esm/helpers.mjs
...
// node_modules/@tamagui/themes/node_modules/@tamagui/theme-builder/dist/esm/defaultTemplates.mjs
...
// node_modules/@tamagui/themes/node_modules/@tamagui/theme-builder/dist/esm/getThemeSuitePalettes.mjs
var paletteSize = 12;
...
// node_modules/@tamagui/themes/node_modules/@tamagui/theme-builder/dist/esm/createThemes.mjs
...
// node_modules/@tamagui/themes/node_modules/@tamagui/theme-builder/dist/esm/defaultTemplatesStronger.mjs
...
// node_modules/@tamagui/themes/node_modules/@tamagui/theme-builder/dist/esm/defaultTemplatesStrongest.mjs
...
// node_modules/@tamagui/themes/node_modules/@tamagui/theme-builder/dist/esm/masks.mjs
var masks = {
...
// node_modules/@tamagui/config/node_modules/@tamagui/constants/dist/esm/constants.mjs
...
// node_modules/@tamagui/config/node_modules/@tamagui/use-presence/dist/esm/PresenceContext.mjs
...
// node_modules/@tamagui/config/node_modules/@tamagui/use-presence/dist/esm/usePresence.mjs
...
// node_modules/@tamagui/config/node_modules/@tamagui/create-theme/dist/esm/isMinusZero.mjs
function isMinusZero2(value) {
  return 1 / value === Number.NEGATIVE_INFINITY;
}
__name(isMinusZero2, "isMinusZero");

// node_modules/@tamagui/config/node_modules/@tamagui/create-theme/dist/esm/themeInfo.mjs
...
// node_modules/@tamagui/config/node_modules/@tamagui/create-theme/dist/esm/createTheme.mjs
...
// node_modules/@tamagui/config/node_modules/@tamagui/create-theme/dist/esm/helpers.mjs
...
// node_modules/@tamagui/config/node_modules/@tamagui/create-theme/dist/esm/masks.mjs
...
var skipMask2 = {
  ...
  mask: /* @__PURE__ */ __name((template, opts) => {
    ...
    return Object.fromEntries(Object.entries(template).filter(([k]) => !skip || !(k in skip)).map(([k, v]) => [k, applyOverrides2(k, v, opts)]));
  }, "mask")
};
function applyOverrides2(key, value, opts) {
  let override, strategy = opts.overrideStrategy;
  const overrideSwap = opts.overrideSwap?.[key];
  if (typeof overrideSwap < "u") override = overrideSwap, strategy = "swap";
  else {
...
__name(applyOverrides2, "applyOverrides");
var createIdentityMask2 = /* @__PURE__ */ __name(() => ({
  name: "identity-mask",
  mask: /* @__PURE__ */ __name((template, opts) => skipMask2.mask(template, opts), "mask")
}), "createIdentityMask");
var createInverseMask2 = /* @__PURE__ */ __name(() => ({
  name: "inverse-mask",
  mask: /* @__PURE__ */ __name((template, opts) => {
    const inversed = objectFromEntries3(objectEntries2(template).map(([k, v]) => [k, -v]));
    return skipMask2.mask(inversed, opts);
  }, "mask")
}), "createInverseMask");
var createShiftMask2 = /* @__PURE__ */ __name(({
  inverse
} = {}, defaultOptions) => ({
  name: "shift-mask",
  mask: /* @__PURE__ */ __name((template, opts) => {
    ...
    for (const [key, value] of values) {
      ...
      const isPositive = value === 0 ? !isMinusZero2(value) : value >= 0, direction = isPositive ? 1 : -1, invert = inverse ? -1 : 1, next = value + strength * direction * invert, clamped = isPositive ? Math.max(min, Math.min(max, next)) : Math.min(-min, Math.max(-max, next));
      out[key] = clamped;
    }
    return skipMask2.mask(out, opts);
  }, "mask")
}), "createShiftMask");
var createWeakenMask2 = /* @__PURE__ */ __name((defaultOptions) => ({
  name: "soften-mask",
  mask: createShiftMask2({}, defaultOptions).mask
}), "createWeakenMask");
var createSoftenMask2 = createWeakenMask2;
var createStrengthenMask2 = /* @__PURE__ */ __name((defaultOptions) => ({
  name: "strengthen-mask",
  mask: createShiftMask2({
    inverse: true
  }, defaultOptions).mask
}), "createStrengthenMask");

// node_modules/@tamagui/config/node_modules/@tamagui/create-theme/dist/esm/applyMask.mjs
...
// node_modules/@tamagui/config/node_modules/@tamagui/create-theme/dist/esm/combineMasks.mjs
var combineMasks2 = /* @__PURE__ */ __name((...masks3) => ({
  name: "combine-mask",
  mask: /* @__PURE__ */ __name((template, opts) => {
    let current = getThemeInfo2(template, opts.parentName), theme;
    for (const mask2 of masks3) {
      if (!current) throw new Error(`Nothing returned from mask: ${current}, for template: ${template} and mask: ${mask2.toString()}, given opts ${JSON.stringify(opts, null, 2)}`);
      const next = applyMaskStateless2(current, mask2, opts);
      current = next, theme = next.theme;
    }
    return theme;
  }, "mask")
...
// node_modules/@tamagui/config/node_modules/@tamagui/theme-builder/dist/esm/helpers.mjs
var objectKeys2 = /* @__PURE__ */ __name((obj) => Object.keys(obj), "objectKeys");
function objectFromEntries4(arr) {
  return Object.fromEntries(arr);
}
__name(objectFromEntries4, "objectFromEntries");

// node_modules/@tamagui/config/node_modules/@tamagui/theme-builder/dist/esm/defaultTemplates.mjs
var getTemplates4 = /* @__PURE__ */ __name(() => {
  const lightTemplates = getBaseTemplates4("light"), darkTemplates = getBaseTemplates4("dark");
  return {
    ...objectFromEntries4(objectKeys2(lightTemplates).map((name) => [`light_${name}`, lightTemplates[name]])),
    ...objectFromEntries4(objectKeys2(darkTemplates).map((name) => [`dark_${name}`, darkTemplates[name]]))
  };
}, "getTemplates");
var getBaseTemplates4 = /* @__PURE__ */ __name((scheme) => {
  const isLight = scheme === "light", bgIndex = 6, lighten = isLight ? -1 : 1, darken = -lighten, borderColor = bgIndex + 3, baseColors = {
    color: -bgIndex,
    colorHover: -bgIndex - 1,
    colorPress: -bgIndex,
...
// node_modules/@tamagui/config/node_modules/@tamagui/theme-builder/dist/esm/getThemeSuitePalettes.mjs
var paletteSize2 = 12;
var generateColorPalette2 = /* @__PURE__ */ __name(({
  palette: buildPalette,
  scheme
}) => {
  if (!buildPalette) return [];
  ...
  for (const [anchorIndex, anchor] of anchors.entries()) {
    ...
    if (add(h, s, l, a), anchorIndex === numAnchors - 1 && palette.length < paletteSize2) for (let step = anchor.index + 1; step < paletteSize2; step++) add(h, s, l);
  }
  const background = palette[0], foreground = palette[palette.length - 1], transparentValues = [background, foreground].map((color) => {
    const [h, s, l] = parseToHsla(color);
    return [hsla(h, s, l, 0), hsla(h, s, l, 0.2), hsla(h, s, l, 0.4), hsla(h, s, l, 0.6), hsla(h, s, l, 0.8)];
...
function getThemeSuitePalettes2(palette) {
  return {
    light: generateColorPalette2({
      palette,
      scheme: "light"
    }),
    dark: generateColorPalette2({
      palette,
      scheme: "dark"
    })
  };
}
__name(getThemeSuitePalettes2, "getThemeSuitePalettes");

// node_modules/@tamagui/config/node_modules/@tamagui/theme-builder/dist/esm/createThemes.mjs
var defaultPalettes2 = createPalettes2(getThemesPalettes2({
  base: {
    palette: ["#fff", "#000"]
  },
  accent: {
...
function getSchemePalette2(colors2) {
  return {
    light: colors2,
    dark: [...colors2].reverse()
  };
}
__name(getSchemePalette2, "getSchemePalette");
function getAnchors2(palette) {
  const numItems = palette.light.length;
  return palette.light.map((lcolor, index) => {
    const dcolor = palette.dark[index], [lhue, lsat, llum, lalpha] = parseToHsla(lcolor), [dhue, dsat, dlum, dalpha] = parseToHsla(dcolor);
    return {
      index: spreadIndex2(11, numItems, index),
      hue: {
        light: lhue,
        dark: dhue
      },
...
__name(getAnchors2, "getAnchors");
function spreadIndex2(maxIndex, numItems, index) {
  return Math.round(index / (numItems - 1) * maxIndex);
}
__name(spreadIndex2, "spreadIndex");
function coerceSimplePaletteToSchemePalette2(def) {
  return Array.isArray(def) ? getSchemePalette2(def) : def;
}
__name(coerceSimplePaletteToSchemePalette2, "coerceSimplePaletteToSchemePalette");
function getThemesPalettes2(props) {
  const base = coerceSimplePaletteToSchemePalette2(props.base.palette), accent = props.accent ? coerceSimplePaletteToSchemePalette2(props.accent.palette) : null, baseAnchors = getAnchors2(base);
  function getSubThemesPalettes(defs) {
    return Object.fromEntries(Object.entries(defs).map(([key, value]) => [key, {
      name: key,
      anchors: value.palette ? getAnchors2(coerceSimplePaletteToSchemePalette2(value.palette)) : baseAnchors
    }]));
  }
  __name(getSubThemesPalettes, "getSubThemesPalettes");
  return {
...
__name(getThemesPalettes2, "getThemesPalettes");
function createPalettes2(palettes) {
  const accentPalettes = palettes.accent ? getThemeSuitePalettes2(palettes.accent) : null, basePalettes = getThemeSuitePalettes2(palettes.base);
  return Object.fromEntries(Object.entries(palettes).flatMap(([name, palette]) => {
    const palettes2 = getThemeSuitePalettes2(palette), oppositePalettes = name.startsWith("accent") ? basePalettes : accentPalettes || basePalettes;
    if (!oppositePalettes) return [];
    const oppositeLight = oppositePalettes.light, oppositeDark = oppositePalettes.dark, bgOffset = 7;
    return [[name === "base" ? "light" : `light_${name}`, [oppositeLight[bgOffset], ...palettes2.light, oppositeLight[oppositeLight.length - bgOffset - 1]]], [name === "base" ? "dark" : `dark_${name}`, [oppositeDark[oppositeDark.length - bgOffset - 1], ...palettes2.dark, oppositeDark[bgOffset]]]];
  }));
}
__name(createPalettes2, "createPalettes");

// node_modules/@tamagui/config/node_modules/@tamagui/theme-builder/dist/esm/defaultTemplatesStronger.mjs
var getTemplates5 = /* @__PURE__ */ __name(() => {
  const lightTemplates = getBaseTemplates5("light"), darkTemplates = getBaseTemplates5("dark");
  return {
    ...objectFromEntries4(objectKeys2(lightTemplates).map((name) => [`light_${name}`, lightTemplates[name]])),
    ...objectFromEntries4(objectKeys2(darkTemplates).map((name) => [`dark_${name}`, darkTemplates[name]]))
  };
}, "getTemplates");
var getBaseTemplates5 = /* @__PURE__ */ __name((scheme) => {
  const isLight = scheme === "light", bgIndex = 6, lighten = isLight ? -1 : 1, darken = -lighten, borderColor = bgIndex + 3, baseColors = {
    color: -bgIndex,
    colorHover: -bgIndex - 1,
    colorPress: -bgIndex,
...
var defaultTemplatesStronger2 = getTemplates5();

// node_modules/@tamagui/config/node_modules/@tamagui/theme-builder/dist/esm/defaultTemplatesStrongest.mjs
var getTemplates6 = /* @__PURE__ */ __name(() => {
  const lightTemplates = getBaseTemplates6("light"), darkTemplates = getBaseTemplates6("dark");
  return {
    ...objectFromEntries4(objectKeys2(lightTemplates).map((name) => [`light_${name}`, lightTemplates[name]])),
    ...objectFromEntries4(objectKeys2(darkTemplates).map((name) => [`dark_${name}`, darkTemplates[name]]))
  };
}, "getTemplates");
var getBaseTemplates6 = /* @__PURE__ */ __name((scheme) => {
  const isLight = scheme === "light", bgIndex = 6, lighten = isLight ? -1 : 1, darken = -lighten, borderColor = bgIndex + 3, baseColors = {
    color: -bgIndex,
    colorHover: -bgIndex - 1,
    colorPress: -bgIndex,
...
var defaultTemplatesStrongest2 = getTemplates6();

// node_modules/@tamagui/config/node_modules/@tamagui/theme-builder/dist/esm/masks.mjs
var masks2 = {
  identity: createIdentityMask2(),
  soften: createSoftenMask2(),
  soften2: createSoftenMask2({
    strength: 2
  }),
  soften3: createSoftenMask2({
    strength: 3
  }),
  strengthen: createStrengthenMask2(),
  inverse: createInverseMask2(),
  inverseSoften: combineMasks2(createInverseMask2(), createSoftenMask2({
    strength: 2
  })),
  inverseSoften2: combineMasks2(createInverseMask2(), createSoftenMask2({
    strength: 3
  })),
  inverseSoften3: combineMasks2(createInverseMask2(), createSoftenMask2({
    strength: 4
  })),
  inverseStrengthen2: combineMasks2(createInverseMask2(), createStrengthenMask2({
    strength: 2
  })),
  strengthenButSoftenBorder: createMask2((template, options) => {
    const stronger = createStrengthenMask2().mask(template, options), softer = createSoftenMask2().mask(template, options);
    return {
      ...stronger,
      borderColor: softer.borderColor,
      borderColorHover: softer.borderColorHover,
  ...
  soften2Border1: createMask2((template, options) => {
    const softer2 = createSoftenMask2({
      strength: 2
    }).mask(template, options), softer1 = createSoftenMask2({
      strength: 1
    }).mask(template, options);
    return {
      ...softer2,
  ...
  soften3FlatBorder: createMask2((template, options) => {
    const borderMask = createSoftenMask2({
      strength: 2
    }).mask(template, options);
    return {
      ...createSoftenMask2({
  ...
  softenBorder: createMask2((template, options) => {
    const plain = skipMask2.mask(template, options), softer = createSoftenMask2().mask(template, options);
    return {
      ...plain,
      borderColor: softer.borderColor,
      borderColorHover: softer.borderColorHover,
  ...
  softenBorder2: createMask2((template, options) => {
    const plain = skipMask2.mask(template, options), softer = createSoftenMask2({
      strength: 2
    }).mask(template, options);
    return {
      ...plain,
